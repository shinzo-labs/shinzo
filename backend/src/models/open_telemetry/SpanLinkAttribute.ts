...
export class SpanLinkAttribute extends CommonModel {
  public span_link_uuid!: string
  public key!: string
  ...
  static initialize(sequelize: Sequelize) {
    SpanLinkAttribute.init(
      ...
      {
        sequelize,
        modelName: 'SpanLinkAttribute',
        tableName: 'span_link_attribute',
