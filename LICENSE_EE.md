# The Shinzo Labs Enterprise License (the "Enterprise License")

Copyright (c) 2025-present Shinzo Labs, Inc.
...
you (and any entity that you represent) hold a valid Shinzo Labs Enterprise license corresponding to your
usage. Subject to the foregoing sentence, you are free to modify this Software and publish patches
to the Software. You agree that Shinzo Labs and/or its licensors (as applicable) retain all right, title and
interest in and to all such modifications and/or patches, and all such modifications and/or patches
may only be used, copied, modified, displayed, distributed, or otherwise exploited with a valid Shinzo Labs
...
agree that Shinzo Labs and/or its licensors (as applicable) retain all right, title and interest in and to
